...
void main() {
  final FlutterReleaserPlatform initialPlatform = FlutterReleaserPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    FlutterReleaser flutterReleaserPlugin = FlutterReleaser();
    MockFlutterReleaserPlatform fakePlatform = MockFlutterReleaserPlatform();
